...
#import "ReadableInterval.h"


@implementation ReadableInterval
 ...
 * <p>
 * Methods that are passed an interval as a parameter will treat <code>nil</code>
...
public interface ReadableInterval {
     ...
     * difference between the start and end instants.
     *
     * @param type  the requested type of the duration, nil means standard
     * @return a time period derived from the interval
     */
