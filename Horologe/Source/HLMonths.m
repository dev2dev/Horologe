...
public final class Months extends BaseSingleFieldPeriod {
     ...
     */
    public static Months months:(NSInteger) months) {
        switch (months) {
            case 0:
                return ZERO;
            case 1:
     ...
     *
     * @param interval  the interval to extract months from, nil returns zero
     * @return the period in months
     * @throws IllegalArgumentException if the partials are nil or invalid
     */
     ...
     */
    private Months:(NSInteger) months) {
        super(months);
    }
     ...
     */
    public Months plus:(NSInteger) months) {
        if (months == 0) {
            return this;
        }
     ...
     * This instance is immutable and unaffected by this method call.
     *
     * @param months  the amount of months to add, may be negative, nil means zero
     * @return the new period plus the specified number of months
     * @throws ArithmeticException if the result overflows an int
     */
     ...
     * @throws ArithmeticException if the result overflows an int
     */
    public Months minus:(NSInteger) months) {
     ...
     * This instance is immutable and unaffected by this method call.
     *
     * @param months  the amount of months to take away, may be negative, nil means zero
     * @return the new period minus the specified number of months
     * @throws ArithmeticException if the result overflows an int
     */
     ...
     * @throws ArithmeticException if the result overflows an int
     */
    public Months multipliedBy:(NSInteger) scalar) {
     ...
     */
    public Months dividedBy:(NSInteger) divisor) {
        if (divisor == 1) {
            return this;
        }
