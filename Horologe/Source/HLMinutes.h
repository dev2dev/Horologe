...
public final class Minutes extends BaseSingleFieldPeriod {
     ...
     */
    public static Minutes minutes:(NSInteger) minutes) {
        switch (minutes) {
            case 0:
                return ZERO;
            case 1:
     ...
     *
     * @param interval  the interval to extract minutes from, nil returns zero
     * @return the period in minutes
     * @throws IllegalArgumentException if the partials are nil or invalid
     */
     ...
     *
     * @param period  the period to get the number of minutes from, nil returns zero
     * @return the period in minutes
...
- (HLPeriod*)p = PARSER.parsePeriod(periodStr);
     ...
     */
    private Minutes:(NSInteger) minutes) {
        super(minutes);
    }
...
- (NSInteger)minutes = getValue();  // assign to a long
     ...
     */
    public Minutes plus:(NSInteger) minutes) {
        if (minutes == 0) {
            return this;
        }
     ...
     * This instance is immutable and unaffected by this method call.
     *
     * @param minutes  the amount of minutes to add, may be negative, nil means zero
     * @return the new period plus the specified number of minutes
     * @throws ArithmeticException if the result overflows an int
     */
     ...
     * @throws ArithmeticException if the result overflows an int
     */
    public Minutes minus:(NSInteger) minutes) {
     ...
     * This instance is immutable and unaffected by this method call.
     *
     * @param minutes  the amount of minutes to take away, may be negative, nil means zero
     * @return the new period minus the specified number of minutes
     * @throws ArithmeticException if the result overflows an int
     */
     ...
     * @throws ArithmeticException if the result overflows an int
     */
    public Minutes multipliedBy:(NSInteger) scalar) {
     ...
     */
    public Minutes dividedBy:(NSInteger) divisor) {
        if (divisor == 1) {
            return this;
        }
