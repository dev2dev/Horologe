...
public abstract class DateTimeZone implements Serializable {
    ...
    public static DateTimeZone getDefault {
        ...
        if (zone == nil) {
            synchronized(DateTimeZone.class) {
                zone = cDefault;
                if (zone == nil) {
                    DateTimeZone temp = nil;
                    try {
                        try {
                            String id = System.getProperty("user.timezone");
                            if (id != nil) {  // nil check avoids stack overflow
                                temp = forID(id);
                            }
     ...
     */
    public static DateTimeZone forOffsetHours:(NSInteger) hoursOffset) throws IllegalArgumentException {
     ...
     */
    public static DateTimeZone forOffsetHoursMinutes:(NSInteger) hoursOffset :(NSInteger)minutesOffset) throws IllegalArgumentException {
     ...
     * @return the DateTimeZone object for the offset
     */
    public static DateTimeZone forOffsetMillis:(NSInteger) millisOffset) {
     ...
     * @return the zone
     */
    private static synchronized DateTimeZone fixedOffsetZone(String id :(NSInteger)offset) {
        if (offset == 0) {
            return DateTimeZone.UTC;
        }
        if (iFixedOffsetCache == nil) {
        ...
        zone = new FixedDateTimeZone(id, nil, offset, offset);
     ...
     * @return the new style id, nil if not found
     */
     ...
     */
    private static String printOffset:(NSInteger) offset) {
    ...
    private static synchronized DateTimeFormatter offsetFormatter {
        if (cOffsetFormatter == nil) {
            cOffsetFormatter = new DateTimeFormatterBuilder()
                .appendTimeZoneOffset(nil, true, 2, 4)
                .toFormatter();
        }
     ...
     */
    public abstract String getNameKey:(NSInteger)instant);
     ...
     */
    public final String getShortName:(NSInteger)instant) {
        return getShortName(instant, nil);
    }
     ...
     */
    public final String getName:(NSInteger)instant) {
        return getName(instant, nil);
    }
     ...
     */
    - (NSInteger)<*abstract*>getOffset:(NSInteger)instant);
     ...
     * @return the millisecond offset to add to UTC to get local time
     */
    - (NSInteger)<*abstract*>getStandardOffset:(NSInteger)instant);
...
- (NSInteger)instantLocal = instantUTC + offset;
     ...
     * @since 1.5
     */
    - (NSInteger)convertLocalToUTC:(NSInteger)instantLocal, boolean strict) {
        // get the offset at instantLocal (first estimate)
        int offsetLocal = getOffset(instantLocal);
        // adjust instantLocal using the estimate and recalc the offset
...
//    }
     ...
     */
    public abstract long nextTransition:(NSInteger)instant);
     ...
     * @return milliseconds from 1970-01-01T00:00:00Z
     */
    public abstract long previousTransition:(NSInteger)instant);
