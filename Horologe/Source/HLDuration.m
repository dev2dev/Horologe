...
public final class Duration
     ...
     * @since 1.6
     */
    public static Duration standardDays:(NSInteger)days) {
        if (days == 0) {
            return ZERO;
        }
     ...
     * @since 1.6
     */
    public static Duration standardHours:(NSInteger)hours) {
        if (hours == 0) {
            return ZERO;
        }
     ...
     * @since 1.6
     */
    public static Duration standardMinutes:(NSInteger)minutes) {
        if (minutes == 0) {
            return ZERO;
        }
     ...
     * @since 1.6
     */
    public static Duration standardSeconds:(NSInteger)seconds) {
        if (seconds == 0) {
            return ZERO;
        }
     ...
     */
    public Duration:(NSInteger)duration) {
        super(duration);
    }
     ...
     */
    public Duration:(NSInteger)startInstant :(NSInteger)endInstant) {
     ...
     * @return the new duration instance
     */
    public Duration withDurationAdded(ReadableDuration durationToAdd :(NSInteger)scalar) {
