...
public final class LocalDateTime
     ...
     */
    public LocalDateTime:(NSInteger)instant) {
     ...
     * @param zone  the time zone, nil means default zone
     */
    public LocalDateTime:(NSInteger)instant, DateTimeZone zone) {
...
- (NSInteger)instant = chronology.getDateTimeMillis(year, monthOfYear, dayOfMonth,
     ...
     */
    LocalDateTime withLocalMillis:(NSInteger)newMillis) {
...
- (NSInteger)instant = getChronology().add(period, getLocalMillis(), scalar);
     ...
     */
    public LocalDateTime plusYears:(NSInteger) years) {
        if (years == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().years().add(getLocalMillis(), years);
     ...
     */
    public LocalDateTime plusMonths:(NSInteger) months) {
        if (months == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().months().add(getLocalMillis(), months);
     ...
     */
    public LocalDateTime plusWeeks:(NSInteger) weeks) {
        if (weeks == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().weeks().add(getLocalMillis(), weeks);
     ...
     */
    public LocalDateTime plusDays:(NSInteger) days) {
        if (days == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().days().add(getLocalMillis(), days);
     ...
     */
    public LocalDateTime plusHours:(NSInteger) hours) {
        if (hours == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().hours().add(getLocalMillis(), hours);
     ...
     */
    public LocalDateTime plusMinutes:(NSInteger) minutes) {
        if (minutes == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().minutes().add(getLocalMillis(), minutes);
     ...
     */
    public LocalDateTime plusSeconds:(NSInteger) seconds) {
        if (seconds == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().seconds().add(getLocalMillis(), seconds);
     ...
     */
    public LocalDateTime plusMillis:(NSInteger) millis) {
        if (millis == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().millis().add(getLocalMillis(), millis);
     ...
     */
    public LocalDateTime minusYears:(NSInteger) years) {
        if (years == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().years().subtract(getLocalMillis(), years);
     ...
     */
    public LocalDateTime minusMonths:(NSInteger) months) {
        if (months == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().months().subtract(getLocalMillis(), months);
     ...
     */
    public LocalDateTime minusWeeks:(NSInteger) weeks) {
        if (weeks == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().weeks().subtract(getLocalMillis(), weeks);
     ...
     */
    public LocalDateTime minusDays:(NSInteger) days) {
        if (days == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().days().subtract(getLocalMillis(), days);
     ...
     */
    public LocalDateTime minusHours:(NSInteger) hours) {
        if (hours == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().hours().subtract(getLocalMillis(), hours);
     ...
     */
    public LocalDateTime minusMinutes:(NSInteger) minutes) {
        if (minutes == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().minutes().subtract(getLocalMillis(), minutes);
     ...
     */
    public LocalDateTime minusSeconds:(NSInteger) seconds) {
        if (seconds == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().seconds().subtract(getLocalMillis(), seconds);
     ...
     */
    public LocalDateTime minusMillis:(NSInteger) millis) {
        if (millis == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().millis().subtract(getLocalMillis(), millis);
     ...
     */
    public LocalDateTime withEra:(NSInteger) era) {
     ...
     * @throws IllegalArgumentException if the value is invalid
     */
    public LocalDateTime withCenturyOfEra:(NSInteger) centuryOfEra) {
     ...
     * @throws IllegalArgumentException if the value is invalid
     */
    public LocalDateTime withYearOfEra:(NSInteger) yearOfEra) {
     ...
     * @throws IllegalArgumentException if the value is invalid
     */
    public LocalDateTime withYearOfCentury:(NSInteger) yearOfCentury) {
     ...
     * @throws IllegalArgumentException if the value is invalid
     */
    public LocalDateTime withYear:(NSInteger) year) {
     ...
     * @throws IllegalArgumentException if the value is invalid
     */
    public LocalDateTime withWeekyear:(NSInteger) weekyear) {
     ...
     * @throws IllegalArgumentException if the value is invalid
     */
    public LocalDateTime withMonthOfYear:(NSInteger) monthOfYear) {
     ...
     * @throws IllegalArgumentException if the value is invalid
     */
    public LocalDateTime withWeekOfWeekyear:(NSInteger) weekOfWeekyear) {
     ...
     * @throws IllegalArgumentException if the value is invalid
     */
    public LocalDateTime withDayOfYear:(NSInteger) dayOfYear) {
     ...
     * @throws IllegalArgumentException if the value is invalid
     */
    public LocalDateTime withDayOfMonth:(NSInteger) dayOfMonth) {
     ...
     * @throws IllegalArgumentException if the value is invalid
     */
    public LocalDateTime withDayOfWeek:(NSInteger) dayOfWeek) {
     ...
     * @throws IllegalArgumentException if the value is invalid
     */
    public LocalDateTime withHourOfDay:(NSInteger) hour) {
     ...
     * @throws IllegalArgumentException if the value is invalid
     */
    public LocalDateTime withMinuteOfHour:(NSInteger) minute) {
     ...
     * @throws IllegalArgumentException if the value is invalid
     */
    public LocalDateTime withSecondOfMinute:(NSInteger) second) {
     ...
     * @throws IllegalArgumentException if the value is invalid
     */
    public LocalDateTime withMillisOfSecond:(NSInteger) millis) {
     ...
     * @throws IllegalArgumentException if the value is invalid
     */
    public LocalDateTime withMillisOfDay:(NSInteger) millis) {
    ...
    public static final class Property extends AbstractReadableInstantFieldProperty {
         ...
         */
        public LocalDateTime addToCopy:(NSInteger) value) {
         ...
         * @throws IllegalArgumentException if the value isn't valid
         */
        public LocalDateTime addWrapFieldToCopy:(NSInteger) value) {
         ...
         * @throws IllegalArgumentException if the value isn't valid
         */
        public LocalDateTime setCopy:(NSInteger) value) {
         ...
         */
        public LocalDateTime setCopy(String text locale:(NSLocale*)locale {
