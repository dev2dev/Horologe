...
public final class LocalTime
     ...
     */
    public static LocalTime fromMillisOfDay:(NSInteger)millisOfDay) {
        return fromMillisOfDay(millisOfDay, nil);
    }
     ...
     */
    public static LocalTime fromMillisOfDay:(NSInteger)millisOfDay, Chronology chrono) {
     ...
     */
    public LocalTime:(HLDateTimeZone*)zone) {
     ...
     */
    public LocalTime:(HLChronology*)chronology) {
     ...
     */
    public LocalTime:(NSInteger)instant) {
     ...
     * @param zone  the time zone, nil means default zone
     */
    public LocalTime:(NSInteger)instant, DateTimeZone zone) {
     ...
     * @param chronology  the chronology, nil means ISOChronology in default zone
     */
    public LocalTime:(NSInteger)instant, Chronology chronology) {
...
- (NSInteger)instant = chronology.getDateTimeMillis(
     ...
     */
    LocalTime withLocalMillis:(NSInteger)newMillis) {
     ...
     *
     * @param partial  the partial set of fields to apply to this time, nil ignored
     * @return a copy of this time with a different set of fields
     * @throws IllegalArgumentException if any value is invalid
     */
    public LocalTime withFields:(id<HLReadablePartial>)partial) {
        if (partial == nil) {
            return this;
        }
     ...
     */
    public LocalTime withField:(HLDateTimeFieldType*)fieldType :(NSInteger)value) {
        if (fieldType == nil) {
            [NSException raise:HL_ILLEGAL_ARGUMENT_EXCEPTION
...
- (NSInteger)instant = fieldType.getField(getChronology()).set(getLocalMillis(), value);
     ...
     * field increased.
     * <p>
     * If the addition is zero or the field is nil, then <code>this</code>
     * is returned.
     * <p>
     ...
     */
    public LocalTime withFieldAdded:(HLDurationFieldType*)fieldType :(NSInteger)amount) {
        if (fieldType == nil) {
            [NSException raise:HL_ILLEGAL_ARGUMENT_EXCEPTION
                    format:@"Field must not be nil"];
        }
...
- (NSInteger)instant = fieldType.getField(getChronology()).add(getLocalMillis(), amount);
     ...
     * @throws ArithmeticException if the result exceeds the internal capacity
     */
    public LocalTime withPeriodAdded:(id<HLReadablePeriod>)period :(NSInteger)scalar) {
...
- (NSInteger)instant = getChronology().add(period, getLocalMillis(), scalar);
     ...
     * @throws ArithmeticException if the result exceeds the internal capacity
     */
    public LocalTime plus:(id<HLReadablePeriod>)period) {
     ...
     */
    public LocalTime plusHours:(NSInteger) hours) {
        if (hours == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().hours().add(getLocalMillis(), hours);
     ...
     */
    public LocalTime plusMinutes:(NSInteger) minutes) {
        if (minutes == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().minutes().add(getLocalMillis(), minutes);
     ...
     */
    public LocalTime plusSeconds:(NSInteger) seconds) {
        if (seconds == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().seconds().add(getLocalMillis(), seconds);
     ...
     */
    public LocalTime plusMillis:(NSInteger) millis) {
        if (millis == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().millis().add(getLocalMillis(), millis);
     ...
     * @throws ArithmeticException if the result exceeds the internal capacity
     */
    public LocalTime minus:(id<HLReadablePeriod>)period) {
        return withPeriodAdded(period, -1);
    }
     ...
     */
    public LocalTime minusHours:(NSInteger) hours) {
        if (hours == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().hours().subtract(getLocalMillis(), hours);
     ...
     */
    public LocalTime minusMinutes:(NSInteger) minutes) {
        if (minutes == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().minutes().subtract(getLocalMillis(), minutes);
     ...
     */
    public LocalTime minusSeconds:(NSInteger) seconds) {
        if (seconds == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().seconds().subtract(getLocalMillis(), seconds);
     ...
     */
    public LocalTime minusMillis:(NSInteger) millis) {
        if (millis == 0) {
            return this;
        }
- (NSInteger)instant = getChronology().millis().subtract(getLocalMillis(), millis);
     ...
     */
    public LocalTime withHourOfDay:(NSInteger) hour) {
     ...
     * @throws IllegalArgumentException if the value is invalid
     */
    public LocalTime withMinuteOfHour:(NSInteger) minute) {
     ...
     * @throws IllegalArgumentException if the value is invalid
     */
    public LocalTime withSecondOfMinute:(NSInteger) second) {
     ...
     * @throws IllegalArgumentException if the value is invalid
     */
    public LocalTime withMillisOfSecond:(NSInteger) millis) {
     ...
     * @throws IllegalArgumentException if the value is invalid
     */
    public LocalTime withMillisOfDay:(NSInteger) millis) {
...
- (NSInteger)resolved = chrono.set(this, instantMillis);
    ...
    public static final class Property extends AbstractReadableInstantFieldProperty {
         ...
         */
        public LocalTime addCopy:(NSInteger) value) {
         ...
         */
        public LocalTime addNoWrapToCopy:(NSInteger) value) {
- (NSInteger)millis = iField.add(iInstant.getLocalMillis(), value);
- (NSInteger)rounded = iInstant.getChronology().millisOfDay().get(millis);
            if (rounded != millis) {
                [NSException raise:HL_ILLEGAL_ARGUMENT_EXCEPTION
                    format:@"The addition exceeded the boundaries of LocalTime"];
            }
         ...
         */
        public LocalTime addWrapFieldToCopy:(NSInteger) value) {
         ...
         * @throws IllegalArgumentException if the value isn't valid
         */
        public LocalTime setCopy:(NSInteger) value) {
         ...
         */
        public LocalTime setCopy(String text locale:(NSLocale*)locale {
