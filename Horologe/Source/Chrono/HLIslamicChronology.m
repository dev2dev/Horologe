...
#import "IslamicChronology.h"


@implementation IslamicChronology
...
//            3L * MILLIS_PER_LONG_YEAR;  // 1389-01-01
        ...
        synchronized (cCache) {
            ...
            if (chrono == nil) {
                if (zone == DateTimeZone.UTC) {
                    ...
                    chrono = new IslamicChronology
                        (ZonedChronology.getInstance(chrono, zone), nil, leapYears);
                }
    ...
    private Object readResolve {
        ...
        return base == nil ? getInstanceUTC() : getInstance(base.getZone());
    }
...
//        };
         ...
         */
        LeapYearPatternType:(NSInteger) index :(NSInteger)pattern) {
            super();
