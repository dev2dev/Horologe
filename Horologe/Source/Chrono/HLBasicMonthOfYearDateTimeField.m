/*
 * BasicMonthOfYearDateTimeField.m
 *
 * Horologe
...
#import "BasicMonthOfYearDateTimeField.h"


@implementation BasicMonthOfYearDateTimeField
...
class BasicMonthOfYearDateTimeField extends ImpreciseDateTimeField {
     ...
     */
    BasicMonthOfYearDateTimeField(BasicChronology chronology :(NSInteger)leapMonth) {
     ...
     */
    - (NSInteger)add:(NSInteger)instant :(NSInteger)months) {
        if (months == 0) {
...
- (NSInteger)instant = 0L;
     ...
     * @return the updated time instant.
     */
    - (NSInteger)addWrapField:(NSInteger)instant :(NSInteger)months) {
...
- (NSInteger)subtrahendRem = subtrahendInstant
     ...
     */
    - (NSInteger)set:(NSInteger)instant :(NSInteger)month) {
