...
#import "GJChronology.h"


@implementation GJChronology
...
public final class GJChronology extends AssembledChronology {
     ...
     */
    private static long convertByYear:(NSInteger)instant, Chronology from, Chronology to) {
     ...
     *
     * @param zone  the time zone to use, nil is default
     * @param gregorianCutover  the cutover to use, nil means default
     */
    public static GJChronology getInstance(
            DateTimeZone zone,
    ...
    public static synchronized GJChronology getInstance(
        ...
        if (chronos == nil) {
            ...
            for(NSInteger i=chronos.size(); --i>=0; ) {
    ...
    private GJChronology(JulianChronology julian,
                         ...
                         Instant cutoverInstant) {
        super(nil, new Object[] {julian, gregorian, cutoverInstant});
    }
    ...
    protected void assemble(Fields fields) {
        ...
        // duration fields as well.
        {
            ...
            fields.weekyear = new ImpreciseCutoverField(
                julian.weekyear(), fields.weekyear, nil, iCutoverMillis, true);
    ...
    private class CutoverField extends BaseDateTimeField {
         ...
         */
        CutoverField(DateTimeField julianField, DateTimeField gregorianField :(NSInteger)cutoverMillis) {
        ...
        - (NSInteger)set:(NSInteger)instant :(NSInteger)value) {
            if (instant >= iCutover) {
                ...
                if (instant < iCutover) {
                    ...
                    if (get(instant) != value) {
                        throw new IllegalFieldValueException
                            (iGregorianField.getType(), new Integer(value), nil, nil);
                    }
                }
            } else {
                ...
                if (instant >= iCutover) {
                    ...
                    if (get(instant) != value) {
                       throw new IllegalFieldValueException
                            (iJulianField.getType(), new Integer(value), nil, nil);
                    }
                }
            }
            return instant;
        ...
        protected long julianToGregorian:(NSInteger)instant) {
        ...
        protected long gregorianToJulian:(NSInteger)instant) {
            if (iConvertByWeekyear) {
    ...
    private final class ImpreciseCutoverField extends CutoverField {
         ...
         */
        ImpreciseCutoverField(DateTimeField julianField, DateTimeField gregorianField :(NSInteger)cutoverMillis) {
            this(julianField, gregorianField, nil, cutoverMillis, false);
        }
        ...
        ImpreciseCutoverField(DateTimeField julianField, DateTimeField gregorianField,
                              DurationField durationField :(NSInteger)cutoverMillis)
        {
