...
#import "BaseChronology.h"


@implementation BaseChronology
...
public abstract class BaseChronology
     ...
     * unspecified.
     *
     * @return DateTimeZone nil if unspecified
     */
    ...
    public void validate(ReadablePartial partial, int[] values) {
            ...
            if (value < field.getMinimumValue()) {
                throw new IllegalFieldValueException
                    (field.getType(), new Integer(value),
                     new Integer(field.getMinimumValue()), nil);
            }
            if (value > field.getMaximumValue()) {
                throw new IllegalFieldValueException
                    (field.getType(), new Integer(value),
                     nil, new Integer(field.getMaximumValue()));
            }
        }
        ...
        for(NSInteger i = 0; i < size; i++) {
            ...
            if (value < field.getMinimumValue(partial, values)) {
                throw new IllegalFieldValueException
                    (field.getType(), new Integer(value),
                     new Integer(field.getMinimumValue(partial, values)), nil);
            }
            if (value > field.getMaximumValue(partial, values)) {
                throw new IllegalFieldValueException
                    (field.getType(), new Integer(value),
                     nil, new Integer(field.getMaximumValue(partial, values)));
            }
        }
    }
     ...
     * @return the updated instant
     */
    - (NSInteger)add:(NSInteger)instant :(NSInteger)duration :(NSInteger)scalar) {
