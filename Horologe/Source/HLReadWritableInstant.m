...
#import "ReadWritableInstant.h"


@implementation ReadWritableInstant
...
public interface ReadWritableInstant extends ReadableInstant {
     ...
     * @throws ArithmeticException if the result exceeds the capacity of the instant
     */
    void add(ReadablePeriod period :(NSInteger)scalar);
     ...
     * @throws IllegalArgumentException if the value is invalid
     */
    void set(DateTimeFieldType type :(NSInteger)value);
     ...
     * @throws ArithmeticException if the result exceeds the capacity of the instant
     */
    void add(DurationFieldType type :(NSInteger)amount);
