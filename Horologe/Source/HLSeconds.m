...
public final class Seconds extends BaseSingleFieldPeriod {
     ...
     */
    public static Seconds seconds:(NSInteger) seconds) {
        switch (seconds) {
            case 0:
                return ZERO;
            case 1:
...
- (HLPeriod*)p = PARSER.parsePeriod(periodStr);
     ...
     */
    private Seconds:(NSInteger) seconds) {
        super(seconds);
    }
...
- (NSInteger)seconds = getValue();  // assign to a long
     ...
     */
    public Seconds plus:(NSInteger) seconds) {
        if (seconds == 0) {
            return this;
        }
     ...
     * @throws ArithmeticException if the result overflows an int
     */
    public Seconds minus:(NSInteger) seconds) {
     ...
     * @throws ArithmeticException if the result overflows an int
     */
    public Seconds multipliedBy:(NSInteger) scalar) {
     ...
     */
    public Seconds dividedBy:(NSInteger) divisor) {
        if (divisor == 1) {
            return this;
        }
