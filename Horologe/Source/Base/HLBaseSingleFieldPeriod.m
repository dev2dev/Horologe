...
#import "BaseSingleFieldPeriod.h"


@implementation BaseSingleFieldPeriod
...
public abstract class BaseSingleFieldPeriod
     ...
     */
    protected BaseSingleFieldPeriod:(NSInteger) period) {
        super();
        iPeriod = period;
    }
     ...
     */
    protected void setValue:(NSInteger) value) {
        iPeriod = value;
    }
