...
public abstract class BaseDateTime
     ...
     */
    public BaseDateTime:(NSInteger)instant) {
     ...
     * @param zone  the time zone, nil means default zone
     */
    public BaseDateTime:(NSInteger)instant, DateTimeZone zone) {
     ...
     * @param chronology  the chronology, nil means ISOChronology in default zone
     */
    public BaseDateTime:(NSInteger)instant, Chronology chronology) {
        super();
     ...
     */
    protected void setMillis:(NSInteger)instant) {
        iMillis = checkInstant(instant, iChronology);
    }
