...
#import "BaseDuration.h"


@implementation BaseDuration
...
public abstract class BaseDuration
     ...
     */
    protected BaseDuration:(NSInteger)duration) {
        super();
        iMillis = duration;
    }
     ...
     */
    protected BaseDuration:(NSInteger)startInstant :(NSInteger)endInstant) {
        super();
     ...
     */
    protected void setMillis:(NSInteger)duration) {
        iMillis = duration;
    }
