 ...
 * @since 1.0
 */
@protocol HLReadableInstant <NSObject>
 ...
 *
 * @param field  the field type to check, may be nil which returns false
 ...
 */
- (NSComparisonResult)compare:(id)readableInstant;
 ...
 * ignoring the chronology), use {@link #isEqual(id<HLReadableInstant>)} or
 ...
 */
- (BOOL)isEqualToReadableInstant:(id)readableInstant;
