...
public abstract class Chronology {
     ...
     */
    public abstract long getDateTimeMillis:(NSInteger) year :(NSInteger)monthOfYear :(NSInteger)dayOfMonth :(NSInteger)millisOfDay);
     ...
     * @throws IllegalArgumentException if the values are invalid
     */
    public abstract long getDateTimeMillis:(NSInteger) year :(NSInteger)monthOfYear :(NSInteger)dayOfMonth,
     ...
     * @throws IllegalArgumentException if the values are invalid
     */
    public abstract long getDateTimeMillis:(NSInteger)instant,
                           int hourOfDay :(NSInteger)minuteOfHour,
                           int secondOfMinute :(NSInteger)millisOfSecond);
     ...
     * @return the updated instant
     */
    public abstract long add:(NSInteger)instant :(NSInteger)duration :(NSInteger)scalar);
