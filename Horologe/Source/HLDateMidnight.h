 ...
 */
- (long)checkInstant:(NSInteger)instant
          chronology:(HLChronology*)chronology;
 ...
 * @throws ArithmeticException if the new datetime exceeds the capacity of a long
 */
- (HLDateMidnight*)withDurationAdded:(id<HLReadableDuration>)durationToAdd 
                         usingScalar:(NSInteger)scalar;
 ...
 * @throws ArithmeticException if the new datetime exceeds the capacity of a long
 */
- (HLDateMidnight*)plusDurationValue:(NSInteger)duration;
 ...
 * @throws ArithmeticException if the new datetime exceeds the capacity of a long
 */
- (HLDateMidnight*)plusDuration:(id<HLReadableDuration>)duration;
 ...
 * @throws ArithmeticException if the new datetime exceeds the capacity of a long
 */
- (HLDateMidnight*)plusPeriod:(id<HLReadablePeriod>)period;
 ...
 * @throws ArithmeticException if the new datetime exceeds the capacity of a long
 */
- (HLDateMidnight*)minusDurationValue:(NSInteger)duration;
 ...
 * @throws ArithmeticException if the new datetime exceeds the capacity of a long
 */
- (HLDateMidnight*)minusDuration:(id<HLReadableDuration>)duration;
 ...
 * @throws ArithmeticException if the new datetime exceeds the capacity of a long
 */
- (HLDateMidnight*)minusPeriod:(id<HLReadablePeriod>)period;
 ...
 * @since 1.3
 */
- (HLDateMidnight*)withEraValue:(NSInteger)era;
 ...
 * @since 1.3
 */
- (HLDateMidnight*)withCenturyOfEraValue:(NSInteger)centuryOfEra;
 ...
 * @since 1.3
 */
- (HLDateMidnight*)withYearOfEraValue:(NSInteger)yearOfEra;
 ...
 * @since 1.3
 */
- (HLDateMidnight*)withYearOfCenturyValue:(NSInteger)yearOfCentury;
 ...
 */
- (id)initWithInstant:(HLDateMidnight*)instant
