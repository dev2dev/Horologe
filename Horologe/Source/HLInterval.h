...
public final class Interval
     ...
     */
    public Interval:(NSInteger)startInstant :(NSInteger)endInstant) {
     ...
     * @since 1.5
     */
    public Interval:(NSInteger)startInstant :(NSInteger)endInstant, DateTimeZone zone) {
     ...
     * @throws IllegalArgumentException if the end is before the start
     */
    public Interval:(NSInteger)startInstant :(NSInteger)endInstant, Chronology chronology) {
