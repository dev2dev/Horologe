...
public final class Partial
     ...
     * The constructor uses the default ISO chronology.
     * 
     * @param type  the single type to create the partial from, not nil
     ...
     * The constructor uses the specified chronology.
     * 
     * @param types  the types to create the partial from, not nil
     * @param values  the values to store, not nil
     * @throws IllegalArgumentException if the types or values are invalid
     */
    public Partial(DateTimeFieldType[] types, int[] values) {
        this(types, values, nil);
    }
     ...
     *
     * @param type  the field type to get the property for, not nil
     ...
     * <p>
     * If there is no appropriate ISO format, nil is returned.
     ...
     *
     * @return a formatter suitable for the fields in this partial, nil
     *  if none is suitable
     */
    ...
    public static class Property extends AbstractPartialFieldProperty implements Serializable {
         ...
         */
        Property(Partial partial :(NSInteger)fieldIndex) {
            super();
            iPartial = partial;
         ...
         */
        public Partial addToCopy:(NSInteger) valueToAdd) {
         ...
         * @throws IllegalArgumentException if the value isn't valid
         */
        public Partial addWrapFieldToCopy:(NSInteger) valueToAdd) {
            int[] newValues = iPartial.getValues();
         ...
         * @throws IllegalArgumentException if the value isn't valid
         */
        public Partial setCopy:(NSInteger) value) {
            int[] newValues = iPartial.getValues();
         ...
         */
        public Partial setCopy(String text locale:(NSLocale*)locale {
            int[] newValues = iPartial.getValues();
