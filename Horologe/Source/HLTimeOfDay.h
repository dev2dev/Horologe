...
public final class TimeOfDay
     ...
     */
    public static TimeOfDay fromMillisOfDay:(NSInteger)millisOfDay) {
     ...
     */
    public static TimeOfDay fromMillisOfDay:(NSInteger)millisOfDay, Chronology chrono) {
     ...
     */
    public TimeOfDay:(NSInteger)instant) {
        super(instant);
    }
     ...
     * @param chronology  the chronology, nil means ISOChronology in the default zone
     */
    public TimeOfDay:(NSInteger)instant, Chronology chronology) {
     ...
     */
    public TimeOfDay:(NSInteger) hourOfDay :(NSInteger)minuteOfHour) {
        this(hourOfDay, minuteOfHour, 0, 0, nil);
    }
     ...
     * @param chronology  the chronology, nil means ISOChronology in the default zone
     */
    public TimeOfDay:(NSInteger) hourOfDay :(NSInteger)minuteOfHour, Chronology chronology) {
     ...
     */
    public TimeOfDay:(NSInteger) hourOfDay :(NSInteger)minuteOfHour :(NSInteger)secondOfMinute) {
        this(hourOfDay, minuteOfHour, secondOfMinute, 0, nil);
    }
     ...
     * @param chronology  the chronology, nil means ISOChronology in the default zone
     */
    public TimeOfDay:(NSInteger) hourOfDay :(NSInteger)minuteOfHour :(NSInteger)secondOfMinute, Chronology chronology) {
     ...
     */
    public TimeOfDay:(NSInteger) hourOfDay :(NSInteger)minuteOfHour :(NSInteger)secondOfMinute :(NSInteger)millisOfSecond) {
        this(hourOfDay, minuteOfHour, secondOfMinute, millisOfSecond, nil);
    }
     ...
     */
    public TimeOfDay:(NSInteger) hourOfDay :(NSInteger)minuteOfHour,
            int secondOfMinute :(NSInteger)millisOfSecond, Chronology chronology) {
     ...
     * @since 1.1
     */
    public TimeOfDay plusHours:(NSInteger) hours) {
     ...
     * @since 1.1
     */
    public TimeOfDay plusMinutes:(NSInteger) minutes) {
     ...
     * @since 1.1
     */
    public TimeOfDay plusSeconds:(NSInteger) seconds) {
     ...
     * @since 1.1
     */
    public TimeOfDay plusMillis:(NSInteger) millis) {
     ...
     * @since 1.1
     */
    public TimeOfDay minusHours:(NSInteger) hours) {
     ...
     * @since 1.1
     */
    public TimeOfDay minusMinutes:(NSInteger) minutes) {
     ...
     * @since 1.1
     */
    public TimeOfDay minusSeconds:(NSInteger) seconds) {
     ...
     * @since 1.1
     */
    public TimeOfDay minusMillis:(NSInteger) millis) {
...
- (NSInteger)resolved = chrono.set(this, instantMillis);
     ...
     * @since 1.3
     */
    public TimeOfDay withHourOfDay:(NSInteger) hour) {
        int[] newValues = getValues();
     ...
     * @since 1.3
     */
    public TimeOfDay withMinuteOfHour:(NSInteger) minute) {
        int[] newValues = getValues();
     ...
     * @since 1.3
     */
    public TimeOfDay withSecondOfMinute:(NSInteger) second) {
        int[] newValues = getValues();
     ...
     * @since 1.3
     */
    public TimeOfDay withMillisOfSecond:(NSInteger) millis) {
        int[] newValues = getValues();
    ...
    public static class Property extends AbstractPartialFieldProperty implements Serializable {
         ...
         */
        Property(TimeOfDay partial :(NSInteger)fieldIndex) {
            super();
            iTimeOfDay = partial;
         ...
         */
        public TimeOfDay addToCopy:(NSInteger) valueToAdd) {
         ...
         * @throws IllegalArgumentException if the value isn't valid
         */
        public TimeOfDay addNoWrapToCopy:(NSInteger) valueToAdd) {
            int[] newValues = iTimeOfDay.getValues();
         ...
         * @throws IllegalArgumentException if the value isn't valid
         */
        public TimeOfDay addWrapFieldToCopy:(NSInteger) valueToAdd) {
            int[] newValues = iTimeOfDay.getValues();
         ...
         * @throws IllegalArgumentException if the value isn't valid
         */
        public TimeOfDay setCopy:(NSInteger) value) {
            int[] newValues = iTimeOfDay.getValues();
         ...
         */
        public TimeOfDay setCopy(String text locale:(NSLocale*)locale {
            int[] newValues = iTimeOfDay.getValues();
