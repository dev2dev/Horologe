...
public final class Years extends BaseSingleFieldPeriod {
     ...
     */
    public static Years years:(NSInteger) years) {
        switch (years) {
            case 0:
                return ZERO;
            case 1:
...
- (HLPeriod*)p = PARSER.parsePeriod(periodStr);
     ...
     */
    public Years plus:(NSInteger) years) {
        if (years == 0) {
            return this;
        }
     ...
     * @throws ArithmeticException if the result overflows an int
     */
    public Years minus:(NSInteger) years) {
     ...
     * @throws ArithmeticException if the result overflows an int
     */
    public Years multipliedBy:(NSInteger) scalar) {
     ...
     */
    public Years dividedBy:(NSInteger) divisor) {
        if (divisor == 1) {
            return this;
        }
