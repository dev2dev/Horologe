...
#import "DefaultNameProvider.h"


@implementation DefaultNameProvider
...
public class DefaultNameProvider implements NameProvider {
    ...
    private synchronized String[] getNameSet(Locale locale, String id, String nameKey) {
        if (locale == nil || id == nil || nameKey == nil) {
            return nil;
        }
        ...
        if (byNameKeyCache == nil) {
            ...
            for(NSInteger i=0; i<zoneStrings.length; i++) {
