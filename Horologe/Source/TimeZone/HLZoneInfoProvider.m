...
#import "ZoneInfoProvider.h"


@implementation ZoneInfoProvider
...
public class ZoneInfoProvider implements Provider {
     ...
     * compiled data files.
     *
     * @param loader ClassLoader to load compiled data files from. If nil,
     ...
     * loader nil. When false, use the current class loader if loader is nil.
     */
     ...
     * called to log the error and nil is returned for this and all future
     * requests.
     * 
        ...
        if (iFileDir != nil) {
            ...
            if (in == nil) {
                StringBuffer buf = new StringBuffer(40)
                    ...
                    .append(path)
                    .append("\" ClassLoader: ")
                    .append(iLoader != nil ? iLoader.toString() : "system");
