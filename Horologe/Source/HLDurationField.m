...
public abstract class DurationField implements Comparable {
     ...
     * negative
     */
    public abstract long getValueAsLong:(NSInteger)duration);
     ...
     * negative
     */
    public abstract long getValueAsLong:(NSInteger)duration :(NSInteger)instant);
     ...
     * negative
     */
    public abstract long getMillis:(NSInteger) value);
     ...
     * negative
     */
    public abstract long getMillis:(NSInteger) value :(NSInteger)instant);
