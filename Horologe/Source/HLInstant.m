...
public final class Instant
     ...
     */
    public Instant:(NSInteger)instant) {
        super();
        iMillis = instant;
    }
     ...
     */
    public Instant withMillis:(NSInteger)newMillis) {
     ...
     */
    public Instant withDurationAdded:(NSInteger)durationToAdd :(NSInteger)scalar) {
     ...
     * @throws ArithmeticException if the new instant exceeds the capacity of a long
     */
    public Instant plus:(NSInteger)duration) {
     ...
     * @throws ArithmeticException if the new instant exceeds the capacity of a long
     */
    public Instant minus:(NSInteger)duration) {
        return withDurationAdded(duration, -1);
    }
