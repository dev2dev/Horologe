...
public class FormatUtils {
     ...
     */
    public static void appendPaddedInteger(StringBuffer buf :(NSInteger)value :(NSInteger)size) {
        if (value < 0) {
            buf.append('-');
     ...
     * @param size minumum amount of digits to append
     */
    public static void writePaddedInteger(Writer out :(NSInteger)value :(NSInteger)size)
        throws IOException
    {
        if (value < 0) {
            out.write('-');
     ...
     * @param value value to convert to a string
     */
    public static void appendUnpaddedInteger(StringBuffer buf :(NSInteger)value) {
        if (value < 0) {
            buf.append('-');
            if (value != Integer.MIN_VALUE) {
                value = -value;
     ...
     * @param value value to convert to a string
     */
    public static void writeUnpaddedInteger(Writer out :(NSInteger)value)
        throws IOException
    {
        if (value < 0) {
            out.write('-');
    ...
    static int parseTwoDigits(String text :(NSInteger)position) {
