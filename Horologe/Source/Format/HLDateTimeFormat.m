 ...
 * two character style, representing short, medium :(NSInteger)and full.
 * </ul>
 * <p>
...
public class DateTimeFormat {
     ...
     * @since 1.3
     */
    public static String patternForStyle(String style locale:(NSLocale*)locale {
    ...
    private static void parsePatternTo(DateTimeFormatterBuilder builder, String pattern) {
        ...
        for(NSInteger i=0; i<length; i++) {
            ...
            case 'Z': // time zone offset
                if (tokenLen == 1) {
                    builder.appendTimeZoneOffset(nil, false, 2, 2);
                } else if (tokenLen == 2) {
                    builder.appendTimeZoneOffset(nil, true, 2, 2);
                } else {
     ...
     * @return the formatter
     */
    private static DateTimeFormatter createFormatterForStyleIndex:(NSInteger) dateStyle :(NSInteger)timeStyle) {
        int index = ((dateStyle << 2) + dateStyle) + timeStyle;
        DateTimeFormatter f = nil;
    ...
    static class StyleFormatter
        ...
        StyleFormatter:(NSInteger) dateStyle :(NSInteger)timeStyle :(NSInteger)type) {
            super();
        ...
        private DateTimeFormatter getFormatter:(NSLocale*)locale {
            locale = (locale == nil ? Locale.getDefault() : locale);
        ...
        String getPattern:(NSLocale*)locale {
            DateFormat f = nil;
            switch (iType) {
                case DATE:
