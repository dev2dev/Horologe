...
#import "MutableInterval.h"


@implementation MutableInterval
...
public class MutableInterval
     ...
     */
    public MutableInterval:(NSInteger)startInstant :(NSInteger)endInstant) {
     ...
     * @throws IllegalArgumentException if the end is before the start
     */
    public MutableInterval:(NSInteger)startInstant :(NSInteger)endInstant, Chronology chronology) {
     ...
     * @throws IllegalArgumentException if the end is before the start
     */
    public MutableInterval:(id<HLReadableInstant> start, ReadableInstant end) {
        super(start, end);
    }
     ...
     */
    public MutableInterval:(id<HLReadableInstant> start, ReadableDuration duration) {
     ...
     * @throws ArithmeticException if the end instant exceeds the capacity of a long
     */
    public MutableInterval:(id<HLReadableInstant> start, ReadablePeriod period) {
        super(start, period);
    }
     ...
     * @throws ArithmeticException if the start instant exceeds the capacity of a long
     */
    public MutableInterval:(id<HLReadablePeriod>)period, ReadableInstant end) {
        super(period, end);
    }
...
- (NSInteger)endMillis = DateTimeUtils.getInstantMillis(end);
     ...
     * Sets the duration of this time interval, preserving the start instant.
     *
     * @param duration  new duration for interval, nil means zero length
     * @throws IllegalArgumentException if the end is before the start
     * @throws ArithmeticException if the end instant exceeds the capacity of a long
     */
