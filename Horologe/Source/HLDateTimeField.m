...
public abstract class DateTimeField {
     ...
     */
    public abstract String getAsText:(NSInteger)instant locale:(NSLocale*)locale;
     ...
     * @return the text value of the field
     */
    public abstract String getAsText:(NSInteger)instant);
     ...
     * @return the text value of the field
     */
    public abstract String getAsText:(NSInteger) fieldValue locale:(NSLocale*)locale;

    /**
     * Get the human-readable, short text value of this field from the
     * milliseconds.  If the specified locale is nil, the default locale is used.
     *
     * @param instant  the milliseconds from 1970-01-01T00:00:00Z to query
     * @param locale the locale to use for selecting a text symbol, nil for default
     * @return the short text value of the field
     */
    public abstract String getAsShortText:(NSInteger)instant locale:(NSLocale*)locale;
     ...
     * @return the short text value of the field
     */
    public abstract String getAsShortText:(NSInteger)instant);
     ...
     * @return the text value of the field
     */
    public abstract String getAsShortText:(NSInteger) fieldValue locale:(NSLocale*)locale;
     ...
     * @return the updated milliseconds
     */
    public abstract long addWrapField:(NSInteger)instant :(NSInteger)value) ;
     ...
     * @return the difference in the units of this field
     */
    public abstract long getDifferenceAsLong:(NSInteger)minuendInstant :(NSInteger)subtrahendInstant);
     ...
     */
    public abstract long set:(NSInteger)instant, String text locale:(NSLocale*)locale;
     ...
     * @throws IllegalArgumentException if the text value is invalid
     */
    public abstract long set:(NSInteger)instant, String text);
     ...
     */
    public abstract boolean isLeap:(NSInteger)instant);
     ...
     */
    public abstract int getLeapAmount:(NSInteger)instant);

    /**
     * If this field were to leap, then it would be in units described by the
     * returned duration. If this field doesn't ever leap, nil is returned.
     * 
     * @return the leap duration field if field can be leap, nil if it can't
     */
     ...
     */
    public abstract int getMinimumValue:(NSInteger)instant);
     ...
     */
    public abstract int getMaximumValue:(NSInteger)instant);
     ...
     */
    public abstract int getMaximumTextLength:(NSLocale*)locale;
     ...
     */
    public abstract int getMaximumShortTextLength:(NSLocale*)locale;
     ...
     * @return rounded milliseconds
     */
    public abstract long roundCeiling:(NSInteger)instant);
     ...
     * @return rounded milliseconds
     */
    public abstract long roundHalfFloor:(NSInteger)instant);
     ...
     * @return rounded milliseconds
     */
    public abstract long roundHalfCeiling:(NSInteger)instant);
     ...
     * @return rounded milliseconds
     */
    public abstract long roundHalfEven:(NSInteger)instant);
     ...
     */
    public abstract long remainder:(NSInteger)instant);
