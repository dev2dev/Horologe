...
@interface HLISOYearOfEraDateTimeField : HLDecoratedDateTimeField {
    
@private
    static HLDateTimeField* singleton;
}
...
- (NSInteger)add:(NSInteger)instant years:(NSInteger)years;

- (NSInteger)addWrapField:(NSInteger)instant years:(NSInteger)years;
...
- (NSInteger)set:(NSInteger)instant year:(NSInteger)year;
