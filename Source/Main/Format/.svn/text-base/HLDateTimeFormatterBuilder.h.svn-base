...
//-----------------------------------------------------------------------
@interface HLMatchingParser : NSObject <HLDateTimeParser> {
    
    @private
NSArray* /*DateTimeParser[]*/ iParsers;
NSInteger iParsedLengthEstimate;
}
...
@end
    ...
    //-----------------------------------------------------------------------
@interface HLDateTimeFormatterBuilder : NSObject {

    @private
    /** Array of printers and parsers (alternating). */
NSArray* iElementPairs;
